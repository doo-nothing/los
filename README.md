...
| **branches** | Mutable Instruments Branches port: probabilistic note routing, toggle/latch |
| **grids** | Mutable Instruments Grids port: the topographic drum map, euclid mode |
| **edges** | Mutable Instruments Edges port: quad chiptune, NES noise + triangle |
...
| **braids** | Mutable Instruments Braids port: the complete macro-oscillator — all 48 firmware models (analog waveforms, sync/sub/triple, ring-mod, swarm, comb, toy, digital filters, vosim/vowel/fof, harmonics, FM family, plucked/bowed/blown/fluted, struck bell/drum, kick/snare/cymbal, wavetables, noise, granular cloud, particle, digital modulation, question-mark) |
